        ...
        content.innerHTML = `
            <div class="envelope-wrapper">
                <div id="envelope" class="close">
                    ...
                    <div class="letter">
                        <p class="words line1">I'm lucky to have you in my life gia</p>
                        <p class="words line2">Can't wait to celebrate our first valentine's ever</p>
                        <p class="words line3">I love you more than you’ll ever know!</p>
                        <p class="words line4">- Alden<3</p>
                    </div>
                </div>
            </div>
            <div class="continue">
        ...
        btnContinue.addEventListener("click", function () {
            ...
            document.getElementById("yesBtn").addEventListener("click", function () {
                content.innerHTML = `
					<div style="text-align: center;">
						...
						<p style="font-size: 24px;">Yessssssss I love you<3</p>
					</div>
                ...
                document.getElementById("surpriseBtn").addEventListener("click", function () {
                    content.innerHTML = `
						<div style="text-align: center; margin-top: 20px;">
							...
							<br>
							<a id="downloadBtn" href="pictures/itinerary.png" download style="display: inline-block; padding: 12px 25px; background: #FF6863; color: white; border-radius: 5px; text-decoration: none; font-size: 18px; font-weight: bold; transition: 0.3s;">Download</a>
						</div>
					`;
                });
            });
            ...
            noBtn.addEventListener("click", function () {
				content.innerHTML = "<div style='text-align: center;'>" +
					...
					"<p style='font-size: 24px;'>oh okay maybe next year</p>" +
					"</div>";
			});
        });
    });
